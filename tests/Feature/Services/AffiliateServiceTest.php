...
class AffiliateServiceTest extends TestCase
{
    ...
    public function test_register_affiliate()
    {
        ...
        $this->assertInstanceOf(Affiliate::class, $affiliate = $this->getAffiliateService()->register($this->merchant, $email = $this->faker->email(), $name = $this->faker->name(), commissionRate: 0.1));
